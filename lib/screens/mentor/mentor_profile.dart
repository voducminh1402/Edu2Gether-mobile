...
class _MentorProfileState extends State<MentorProfile> {
  ...
  List<dynamic>? _date;
  final List<String> _dateOfWeek = ["T2", "T3", "T4", "T5", "T6", "T7", "CN"];
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: CircleAvatar(
                        backgroundImage: NetworkImage(_mentor!.image),
                  ...
                  Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          return InkWell(
                            onTap: () => Get.to(
                                () => VideoCourseDetails(id: _course![i].id)),
                            child: Container(
